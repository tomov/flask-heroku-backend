class DatabaseConstants:
    DATABASE_URI_TEMPLATE = "mysql://root:wtf@blabla.rds.amazonaws.com/%s?charset=utf8&init_command=set%%20character%%20set%%20utf8" # TODO CHANGE AND PUT IN ENV VARIABLE
